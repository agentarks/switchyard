...
- `sy status [session]`
  ...
  - prints a tab-separated session table ordered by current follow-up priority first and most recent update within each follow-up bucket
