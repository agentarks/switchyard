...
- Align `PLAN.md`, `docs/next-steps.md`, `docs/focus-tracker.md`, and `docs/backlog.md`
...
- If `PLAN.md` is not updated along with the planning docs, the gap-cycle language will keep reappearing
