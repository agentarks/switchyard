...
Canonical implementation-slice counts now live in [docs/slice-ledger.md](slice-ledger.md); this file stays focused on the current milestone and the next few slices that should advance it.
...
2. Advance reintegration and operator closure with narrow slices.
...
3. Keep each slice milestone-scoped and reviewable.
- improve one clear reintegration step at a time
